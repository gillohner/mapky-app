...
export function MobileBottomSheet({
  ...
  return (
    <div
      className="pointer-events-auto absolute bottom-0 left-12 right-0 z-10 flex flex-col rounded-t-2xl border-t border-l border-border bg-background shadow-2xl md:hidden"
      style={{
        height: `${SHEET_VH}vh`,
